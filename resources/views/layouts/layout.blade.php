...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-assets/css/new-style.css') }}">
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl footer-offset">
    ...
    <header id="header" class="bg-white navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered">
        <div class="navbar-nav-wrap">
            ...
            <a class="navbar-brand" href="#!" aria-label="Rotas">
                ...
                <img class="navbar-brand-logo-mini" src="{{ asset('admin-assets/img/logos/main.png') }}" alt="Logo" data-hs-theme-appearance="dark">
            </a>
            <!-- End Logo -->
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset">
                ...
                <a class="navbar-brand" href="#!" aria-label="Front">
                    ...
                    <img class="navbar-brand-logo-mini" src="{{ asset('admin-assets/img/logos/main-white.png') }}" alt="Logo" data-hs-theme-appearance="dark" style="min-width: 3.2rem; max-width: 3.2rem;" />
                </a>
                    ...
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesOrdersMenu" class="nav-collapse collapse" data-bs-parent="#navbarVerticalMenuPagesMenu">
                                    <a class="nav-link @yield('orders')" href="{{ route('orders') }}">Overview <span class="badge bg-info rounded-pill ms-1">New</span></a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                        ...
                        <div class="nav-item">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <a class="nav-link" data-placement="left" href="{{ route('logout') }}" onclick="event.preventDefault();
                            ...
                            <div class="dropdown dropup">
                                ...
                                <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="otherLinksDropdown">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <span class="text-truncate" title="Whats new?">Whats new?</span>
                                    </a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBuilder" aria-labelledby="offcanvasBuilderLabel">
        <div class="offcanvas-header align-items-start">
            <div>
                <h3 id="offcanvasBuilderLabel">Builder</h3>
        ...
        <div class="offcanvas-body">
            ...
            <p>Choose your preffered appearance</p>

            <div class="row gx-3">
                <!-- Check -->
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        <input type="radio" class="form-check-input" name="layoutSkinsRadio" id="layoutSkinsRadio1" checked value="default">
                        <label class="mb-2 form-check-label" for="layoutSkinsRadio1">
                <img class="form-check-img" src="{{ asset('admin-assets/img/415x310/img1.jpg') }}" alt="Default">
                </label>
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="layoutSkinsRadio2">
                <img class="form-check-img" src="{{ asset('admin-assets/img/415x310/img2.jpg') }}" alt="Dark Mode">
                </label>
            ...
            <div class="row gx-3">
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="navbarLayoutSkinsRadio1">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts-light/sidebar-default.svg') }}" alt="Dark" data-hs-theme-appearance="dark">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts/sidebar-default.svg') }}" alt="Default" data-hs-theme-appearance="default">
                        </label>
                        <span class="form-check-text">Default</span>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="navbarLayoutSkinsRadio2">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts-light/sidebar-dark.svg') }}" alt="Dark" data-hs-theme-appearance="dark">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts/sidebar-dark.svg') }}" alt="Default" data-hs-theme-appearance="default">
                        </label>
            ...
            <div class="row gx-3">
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="sidebarNavOptions1">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts-light/demo-layouts-default-classic.svg') }}" alt="Dark" data-hs-theme-appearance="dark">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts/demo-layouts-default-classic.svg') }}" alt="Default" data-hs-theme-appearance="default">
                        </label>
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="sidebarNavOptions2">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts-light/demo-layouts-nav-tabs.svg') }}" alt="Image Description" data-hs-theme-appearance="dark">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts/demo-layouts-nav-tabs.svg') }}" alt="Image Description" data-hs-theme-appearance="default">
                        </label>
            ...
            <!-- Form Switch -->
            <label class="mb-3 row form-check form-switch" for="builderFluidSwitch">
                <span class="col-10 ms-0">
                    <span class="mb-1 d-block h4">Header Layout Options</span>
            ...
            <div class="row gx-3">
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="headerLayoutOptions1">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts/header-default-container.svg') }}" alt="Image Description" data-hs-theme-appearance="default">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts-light/header-default-container.svg') }}" alt="Image Description" data-hs-theme-appearance="dark">
                        </label>
                        <span class="form-check-text">Default</span>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="text-center form-check form-check-label-highlighter">
                        ...
                        <label class="mb-2 form-check-label" for="headerLayoutOptions2">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts/header-double-line-container.svg') }}" alt="Image Description" data-hs-theme-appearance="default">
                            <img class="form-check-img" src="{{ asset('admin-assets/svg/layouts-light/header-double-line-container.svg') }}" alt="Image Description" data-hs-theme-appearance="dark">
                        </label>
    ...
    <!-- Builder Toggle -->
    <div id="builderOffcanvas" class="bottom-0 mb-5 position-fixed end-0 me-5" style="z-index: 3;" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBuilder" aria-controls="offcanvasBuilder">
    ...
    <div class="d-none js-build-layouts">
        <div class="js-build-layout-header-default">
            <!-- Single Header -->
            <header id="header" class="bg-white navbar navbar-expand-lg navbar-bordered ">
                <div class="container">
                                            ...
                                            <div class="card-header card-header-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="navbarNotificationsDropdownSettings">
                                                        ...
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-gift dropdown-item-icon"></i> Whats new?
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <img class="avatar avatar-sm avatar-circle" src="admin-assets/img/160x160/img3.jpg" alt="Image Description">
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Col -->
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="avatar avatar-sm avatar-circle">
                                                                                <img class="avatar-img" src="admin-assets/img/160x160/img10.jpg" alt="Image Description">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Col -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="avatar avatar-sm avatar-circle">
                                                                                <img class="avatar-img" src="admin-assets/svg/brands/google-icon.svg" alt="Image Description">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Col -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="avatar avatar-sm avatar-circle">
                                                                                <img class="avatar-img" src="admin-assets/img/160x160/img7.jpg" alt="Image Description">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Col -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="avatar avatar-sm avatar-circle">
                                                                                <img class="avatar-img" src="admin-assets/img/160x160/img5.jpg" alt="Image Description">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Col -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="avatar avatar-sm avatar-circle">
                                                                                <img class="avatar-img" src="admin-assets/img/160x160/img8.jpg" alt="Image Description">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Col -->
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-card navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="navbarAppsDropdown" style="width: 25rem;">
                                            ...
                                            <div class="card-body card-body-height">
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-4x3" src="admin-assets/svg/brands/atlassian-icon.svg" alt="Image Description">
                                                        </div>
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-4x3" src="admin-assets/svg/brands/slack-icon.svg" alt="Image Description">
                                                        </div>
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-4x3" src="admin-assets/svg/brands/google-webdev-icon.svg" alt="Image Description">
                                                        </div>
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-4x3" src="admin-assets/svg/brands/frontapp-icon.svg" alt="Image Description">
                                                        </div>
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-4x3" src="admin-assets/svg/illustrations/review-rating-shield.svg" alt="Image Description">
                                                        </div>
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="dropdown">
                                        <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" data-bs-dropdown-animation>
                                            <div class="avatar avatar-sm avatar-circle">
                                                <img class="avatar-img" src="admin-assets/img/160x160/img6.jpg" alt="Image Description">
        ...
        <div class="js-build-layout-header-double">
            ...
            <header id="header" class="navbar navbar-expand-lg navbar-bordered navbar-spacer-y-0 flex-lg-column">
                <div class="py-2 navbar-dark w-100 bg-dark">
                    <div class="container">
                        <div class="navbar-nav-wrap">
                            <!-- Logo -->
                            <a class="navbar-brand" href="index.html" aria-label="Front">
                    <img class="navbar-brand-logo" src="admin-assets/svg/logos/logo-white.svg" alt="Logo">
                </a>
                            <!-- End Logo -->
                                ...
                                Notification panel <i class="bi-search ms-1"></i>
                                    ...
                                    <i class="bi-paint-bucket"></i>
                                                ...
                                                <a class="dropdown-item" href="index.html">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-circle" src="admin-assets/img/160x160/img10.jpg" alt="Image Description">
                                                        </div>
                                                        <div class="flex-grow-1 text-truncate ms-2">
                                                ...
                                                <a class="dropdown-item" href="index.html">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-xs avatar-circle" src="admin-assets/img/160x160/img3.jpg" alt="Image Description">
                                                        </div>
                                                        <div class="flex-grow-1 text-truncate ms-2">
                                            ...
                                            <!-- Footer -->
                                            <a class="text-center card-footer" href="index.html">
            ...
            <div class="mb-5 list-group list-group-sm list-group-flush list-group-no-gutters">
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">b</kbd>
                        </div>
                    </div>
                    <!-- End Row -->
                </div>
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">i</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">u</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Alt</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">s</kbd>
                            <!-- End Col -->
                        </div>
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">s</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">e</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
            ...
            <div class="mb-5 list-group list-group-sm list-group-flush list-group-no-gutters">
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">r</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">n</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">p</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Tab</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block"><i class="bi-arrow-up-short"></i></kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block"><i class="bi-arrow-down-short fs-5"></i></kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Alt</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">m</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">z</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">y</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
            ...
            <div class="list-group list-group-sm list-group-flush list-group-no-gutters">
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Alt</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">n</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">p</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">s</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">o</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-end">
                            <kbd class="mb-1 d-inline-block">Ctrl</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">Shift</kbd> <span class="text-muted small">+</span> <kbd class="mb-1 d-inline-block">/</kbd>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
            ...
            <ul class="step step-icon-sm step-avatar-sm">
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        ...
                        <div class="step-content">
                            ...
                            <p class="mb-1 fs-5">Added 2 files to task <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fd-7</a></p>
                                ...
                                <li class="list-group-item list-group-item-light">
                                    <div class="row gx-1">
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar avatar-xs" src="admin-assets/svg/brands/excel-icon.svg" alt="Image Description">
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar avatar-xs" src="admin-assets/svg/brands/word-icon.svg" alt="Image Description">
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <span class="d-block fs-6 text-dark text-truncate" title="weekly-reports.xls">weekly-reports.xls</span>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        ...
                        <div class="step-content">
                            ...
                            <p class="mb-1 fs-5">Marked <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fr-6</a> as <span class="badge bg-soft-success text-success rounded-pill"><span class="legend-indicator bg-success"></span>"Completed"</span>
                            </p>
                        ...
                        <div class="step-content">
                            ...
                            <ul class="list-group list-group-sm">
                                <li class="list-group-item list-group-item-light">
                                    <div class="row gx-1">
                                        <div class="col">
                                            <img class="rounded img-fluid" src="admin-assets/svg/components/card-1.svg" alt="Image Description">
                                        </div>
                                        <div class="col">
                                            <img class="rounded img-fluid" src="admin-assets/svg/components/card-2.svg" alt="Image Description">
                                        </div>
                                        <div class="col">
                                            <img class="rounded img-fluid" src="admin-assets/svg/components/card-3.svg" alt="Image Description">
                                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        ...
                        <div class="step-content">
                            ...
                            <p class="mb-1 fs-5">Marked <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span class="badge bg-soft-success text-success rounded-pill"><span class="legend-indicator bg-success"></span>"Completed"</span>
                            </p>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        ...
                        <div class="step-content">
                            ...
                            <p class="mb-1 fs-5">Earned a "Top endorsed" <i class="bi-patch-check-fill text-primary"></i> badge</p>
                ...
                <i class="bi-person-fill"></i>
                        ...
                        <div class="step-content">
                            ...
                            <p class="mb-1 fs-5">Marked <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span class="badge bg-soft-primary text-primary rounded-pill"><span class="legend-indicator bg-primary"></span>"In progress"</span>
                            </p>
                ...
                <div class="modal-body p-sm-5">
                    <div class="text-center">
                        <div class="mx-auto mb-4 w-75 w-sm-50">
                            <img class="img-fluid" src="admin-assets/svg/illustrations/oc-collaboration.svg" alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid" src="admin-assets/svg/illustrations-light/oc-collaboration.svg" alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                ...
                <div class="text-center modal-footer d-block py-sm-5">
                    ...
                    <div class="mx-auto w-85">
                        <div class="row justify-content-between">
                            <div class="col">
                                <img class="img-fluid" src="admin-assets/svg/brands/gitlab-gray.svg" alt="Image Description">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="admin-assets/svg/brands/fitbit-gray.svg" alt="Image Description">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="admin-assets/svg/brands/flow-xo-gray.svg" alt="Image Description">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="admin-assets/svg/brands/layar-gray.svg" alt="Image Description">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @if(session()->has('info'))
        ...
        <div id="liveToast" class="position-fixed toast show" role="alert" aria-live="assertive" aria-atomic="true" style="top: 20px; right: 20px; z-index: 1000;">
            <div class="toast-header">
                ...
                <div class="flex-grow-1 ms-3">
                    <h5 class="mb-0">Action notice!</h5>
    ...
    @if(Session::has('warning'))
        ...
        <div id="liveToast" class="position-fixed toast show" role="alert" aria-live="assertive" aria-atomic="true" style="top: 20px; right: 20px; z-index: 1000;">
            <div class="toast-header">
                <div class="d-flex align-items-center flex-grow-1">
                <div class="flex-shrink-0">
                    <img class="avatar avatar-sm avatar-circle" src="{{ asset('admin-assets/img/others/warning-icon.png') }}" alt="Image description">
                </div>
                <div class="flex-grow-1 ms-3">
                    <h5 class="mb-0">Action not completed!</h5>
                    <small class="ms-auto">{{ now()->diffForHumans() }}</small>
                </div>
                <div class="text-end">
                    <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
    ...
    @if(Session::has('danger'))
        ...
        <div id="liveToast" class="position-fixed toast show" role="alert" aria-live="assertive" aria-atomic="true" style="top: 20px; right: 20px; z-index: 1000;">
            <div class="toast-header">
                <div class="d-flex align-items-center flex-grow-1">
                <div class="flex-shrink-0">
                    <img class="avatar avatar-sm avatar-circle" src="{{ asset('admin-assets/img/others/danger-icon.png') }}" alt="Image description">
                </div>
                <div class="flex-grow-1 ms-3">
                    <h5 class="mb-0">Action not completed!</h5>
                    <small class="ms-auto">{{ now()->diffForHumans() }}</small>
